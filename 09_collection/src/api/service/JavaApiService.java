...
public class JavaApiService {
	 ...
	 * 
	 * 2) String s2 = new String("Hello");  // new 연산자 이용 방법
...
//		String s2 = s1;
	...
	public void test4() {
		...
		// 3) String 문자열.replace("대 상문자열", "바꿀 문자열")
		// - 문자열 변경
